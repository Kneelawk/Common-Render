...
public record GltfNode(Optional<String> name, float[] children, float[] rotation, float[] scale, float[] translation,
    ...
    public static final Codec<GltfNode> CODEC = RecordCodecBuilder.create(instance -> instance.group(
        ...
        Codecs.FLOAT_ARRAY.optionalFieldOf("children", new float[0]).forGetter(GltfNode::children),
